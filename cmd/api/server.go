...
func (app *application) serve() error {
	...
	go func() {
		...
		// Log a message to say that the signal has been caught. Call the String() method
		// on the signal to get the signal name and include it in the log entry properties.
		...
		// hit). We relay this return value to the shutdownError channel if it
		// returns an error.
