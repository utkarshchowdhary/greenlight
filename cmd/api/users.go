...
func (app *application) updateUserPasswordHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Parse user's new password and password reset token from the request body.
	err := app.readJSON(w, r, &input)
	if err != nil {
		app.badRequestResponse(w, r, err)
		return
	...
	// Validate the user's new password and password reset token provided by the client.
