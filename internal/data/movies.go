...
// The GetAll() method returns a slice of movies,
// it accepts various filter parameters as arguments.
func (m MovieModel) GetAll(title string, genres []string, filters Filters) ([]*Movie, Metadata, error) {
	// Construct the SQL query to retrieve movie records based on filter conditions.
	// Use full-text search for the title filter.
	// Add an ORDER BY clause and interpolate the sort column and direction.
	// Importantly include a secondary sort on the movie ID to ensure a
	// consistent ordering.
	query := fmt.Sprintf(`
	...
	// If everything went OK, then return the slice of movies along with metadata.
